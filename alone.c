...
void check_expiration() {
    ...
    if (current_time > expiration_time) {
        printf("The program has expired. Please update to continue.\n");
        exit(1);
    }
}
...
void usage() {
    printf("Usage: ./pubg <ip> <port> <duration> <threads>\n");
    exit(1);
}
...
int main(int argc, char *argv[]) {
    ...
    printf("🔻ATTACK FINISHED🔺owner :- @GodXaloneBoy\n");
    return 0;
}
